...
def main():
    ...
    for _ in range(args.num_runs):
        ...
        # rng_generate_sample_values = rng_generate_sample_values()
        # rng_seq_gen_values = rng_seq_gen_values()
        # getting randomized value list
        try:
            # getting trees
            ...
            # call_seq_gen(get_trees[0], args, "lineage", config)
...
#
#
# def rng_generate_sample_values():
#
#
# def rng_seq_gen_values():
